...
class UserModel():
    def __init__(self, uid, name, bio, age, birth_date, photos,
        ...
        # additions
        self.pic_dir = os.path.join('Database','Pictures',"{}_{}".format(self.id,self.name))
...
class NormalUser(UserModel):
    ...
    def __get_info__(self):
        str_out='id={},name={}, bio={}, age={}, birth_date={}, photos={}, gender={}, distance={}, job_name={}, job_title={}, school_name={}'.format(
                            self.id,
                            self.name, 
                            self.bio, 
                            self.age, 
